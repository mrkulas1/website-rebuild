...
<main class="content">
    ...
    <div class="press">
        ...
        <a href="press_releases/2017 Run for the Walls.pdf" target="_blank">
            Run for the Walls
        </a><br>
        <a href="press_releases/2017 Golf Outing Sponsors.pdf" target="_blank">
    ...
    <div class="press">
        ...
        <a href="press_releases/2016 Run for the Walls  results.pdf" target="_blank">
            Run for the Walls
        </a><br>
        <a href="press_releases/2016 golf outing.pdf" target="_blank">
            Golf Outing Sponsors
        </a><br>
        <a href="press_releases/2016 Balkum ground breaking.pdf" target="_blank">
            Balkum Ground Breaking
        </a><br>
        <a href="press_releases/2016 Thrivent.pdf" target="_blank">
            Thrivent Donation
        </a>
    </div>
    <div class="press">
